<nav>
    ...
    <div id="nav-content">
        ...
        <div id="nav-links">
            <a href="skills.php" class="btn-process"><i class="fas fa-list-ul"></i>Skills</a>
            <a href="showcase.php" class="btn-showcase"><i class="fas fa-layer-group"></i>Showcase</a>
            ...
            <a href="mailto:me@austinnorris.website"><i class="fas fa-paper-plane"></i>Email</a>
